...
CadreLeft= Frame(screen,width=300,height=800)
Cadreright= Frame(screen,width=300,height=800)

#mise en forme des cadre:
LabelTitre2 = Label(CadreLeft, text="Temperature",width=10,font=("arial",30))
LabelTitre1 = Label(Cadreright,text="Batterie   ",width=10,font=("arial",30))
LabelTemp = Label(CadreLeft)
LabelBat = Label(Cadreright)
LabelEcartG1 = Label(CadreLeft,height="17",width="10")
LabelAffichageG = Label(CadreLeft,width="10",height="2")
LabelEcartG2 = Label(CadreLeft,height="8",width="10")
LabelImageG = Label(CadreLeft,image=IMGNORMAL1)
LabelEcartG3 = Label(CadreLeft,height="4",width="10")

LabelEcartD1 = Label(Cadreright,height="6",width="10")
LabelTextD1 = Label(Cadreright,text="Tension de la batterie",fg="white")
LabelAffichageD1 = Label(Cadreright,width="10",height="2")
LabelEcartD2 = Label(Cadreright,height="8",width="10")
LabelTextD2 = Label(Cadreright,text="Pourcentage",fg="white")
LabelAffichageD2 = Label(Cadreright,width="10",height="2")
LabelEcartD3 = Label(Cadreright,height="8",width="10")
LabelImageD = Label(Cadreright,image=IMG100)
LabelEcartD4 = Label(Cadreright,height="4",width="10")
#Bouton
def CommandStart():
    Telementrie.open()
    while VarBoucle == 1:
